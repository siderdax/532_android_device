...
public class TmuCpuActivity extends Activity implements OnTouchListener, OnGestureListener {
	
	private String TAG = "TmuCpuActivity";
	...
	private TableLayout tmuCpuLayout;
	private ScrollView tmuCpuScrollView;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tmu_cpu);
...
//				//tmuCpuScrollView.addView(v3);
		...
		tmuCpuLayout = (TableLayout) findViewById(R.id.tmu_cpu_layout);
		tmuCpuScrollView = (ScrollView) findViewById(R.id.tmu_cpu_scroll_view);
		...
		TableLayout tmuLayout = (TableLayout) findViewById(R.id.tmu_cpu_layout);
		//tmuLayout.setOnTouchListener(this);
		//tmuLayout.setClickable(true);
		tmuCpuScrollView.setOnTouchListener(this);
		tmuCpuScrollView.setClickable(true);

		rebootButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				new AlertDialog.Builder(TmuCpuActivity.this)
				.setTitle("Hint")
		...
		Intent intent = new Intent(TmuCpuActivity.this, TmuService.class);
		startService(intent);
	...
	private void createFloatWindow() {
		...
		if (floatWindow == null) { // onDraw will be called since View created first time
			...
			//floatWindowParams.type = 2010; // still show on lockscreeen
			...
			app.setSliderView(sliderView);
		} else  { // onDraw must be triggered diberately
...
//	}
	...
	public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
		if (e1.getX() - e2.getX() > FLING_MIN_DISTANCE && Math.abs(velocityX) > FLING_MIN_VELOCITY) {
			...
			//myView.notifyGesture(TmuSliderView.FLING_LEFT);
//			Intent intent = new Intent("com.android.TestMode.TmuTunningActivity");
//			intent.putExtra("direction", "left");
//			sendBroadcast(intent);
			...
			//myView.notifyGesture(TmuSliderView.FLING_RIGHT);
//			Intent intent = new Intent("com.android.TestMode.TmuTunningActivity");
//			intent.putExtra("direction", "right");
//			sendBroadcast(intent);
			//sendGesutreMsg(TmuBrain.FLING_RIGHT);
			//tmuBrain.setContext(this);
			tmuBrain.updateIndexByGesture(TmuBrain.FLING_RIGHT);
			tmuBrain.updateSliderView();
