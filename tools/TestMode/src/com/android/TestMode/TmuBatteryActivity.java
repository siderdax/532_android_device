...
public class TmuBatteryActivity extends Activity implements OnTouchListener, OnGestureListener {
	
	private String TAG = "TumuBatteryActivity";
	...
	private ScrollView tmuBatteryScrollView;
	private LayoutInflater inflater;
	private TableLayout tmuBatteryLayout;
...
//				//tmuCpuScrollView.addView(v3);
		...
		rebootButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				new AlertDialog.Builder(TmuBatteryActivity.this)
				.setTitle("Hint")
		...
		//TableLayout tmuLayout = (TableLayout) findViewById(R.id.tmu_battery_layout);
		tmuBatteryLayout = (TableLayout) findViewById(R.id.tmu_battery_layout);
		tmuBatteryScrollView = (ScrollView) findViewById(R.id.tmu_battery_scroll_view);
		tmuBatteryScrollView.setOnTouchListener(this);
		tmuBatteryScrollView.setClickable(true);
...
//			sendBroadcast(intent);
			...
			//setContentView(R.layout.tmu_battery);
			//tmuBrain.setContext(this);
			tmuBrain.updateIndexByGesture(TmuBrain.FLING_LEFT);
			tmuBrain.updateSliderView();
