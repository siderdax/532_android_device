...
public class TmuBbActivity extends Activity implements OnTouchListener, OnGestureListener {
	
	private String TAG = "TmuBbActivity";
	...
	private ScrollView tmuBbScrollView;
	private Spinner spinnerTz;
	private Spinner spinnerTrip;
	private TableLayout tmuBbLayout;
...
//				//tmuCpuScrollView.addView(v3);
		...
		rebootButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				new AlertDialog.Builder(TmuBbActivity.this)
				.setTitle("Hint")
...
//		TableLayout tmuLayout = (TableLayout) findViewById(R.id.tmu_bb_layout);
//		tmuLayout.setOnTouchListener(this);
//		tmuLayout.setClickable(true);
		tmuBbScrollView = (ScrollView) findViewById(R.id.tmu_bb_scroll_view);
		tmuBbLayout = (TableLayout) findViewById(R.id.tmu_bb_layout);
		tmuBbScrollView.setOnTouchListener(this);
		tmuBbScrollView.setClickable(true);
