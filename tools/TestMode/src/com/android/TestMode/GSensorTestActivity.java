	...
	private void setupBottom() {
       ...
       b.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
              //passed
              setResult(RESULT_OK);;
              BaseActivity.NewstoreRusult(true, "G Sensor test",mEngSqlite);//[yeez_haojie add 11.27]
              finish();
           }
       });
       ...
       b.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
              ...
              BaseActivity.NewstoreRusult(false, "G Sensor test",mEngSqlite);//[yeez_haojie add 11.27]
              finish();
           }
       });
    }
