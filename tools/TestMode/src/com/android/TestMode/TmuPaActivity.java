...
public class TmuPaActivity extends Activity implements OnTouchListener, OnGestureListener {
	
	private String TAG = "TmuPaActivity";
	...
	private ScrollView tmuPaScrollView;
	private LayoutInflater inflater;
	private TableLayout tmuPaLayout;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tmu_pa);
...
//				//tmuCpuScrollView.addView(v3);
		...
		rebootButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				new AlertDialog.Builder(TmuPaActivity.this)
				.setTitle("Hint")
...
//		TableLayout tmuLayout = (TableLayout) findViewById(R.id.tmu_pa_layout);
//		tmuLayout.setOnTouchListener(this);
//		tmuLayout.setClickable(true);
		tmuPaScrollView = (ScrollView) findViewById(R.id.tmu_pa_scroll_view);
		tmuPaLayout = (TableLayout) findViewById(R.id.tmu_pa_layout);
		tmuPaScrollView.setOnTouchListener(this);
		tmuPaScrollView.setClickable(true);
